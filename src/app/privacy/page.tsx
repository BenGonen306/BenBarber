    ...
    <section style={{ padding: "120px 1.5rem 100px", maxWidth: 800, margin: "0 auto" }}>
      ...
      <div style={{ background: C.surface, border: "1px solid rgba(212,175,55,0.15)", borderRadius: 20, padding: "36px 32px" }}>
        ...
        <Section title="1. מידע שנאסף">
          <p>בעת השימוש באתר אנו עשויים לאסוף את הפרטים הבאים: שם מלא, מספר טלפון, כתובת דואר אלקטרוני, ופרטים נוספים שתבחר למסור בטופס יצירת הקשר, בטופס ההרשמה לאקדמיה, או במערכת קביעת התורים (Cal.com). כן נאסף מידע גלישה אנונימי באמצעות עוגיות אנליטיקס (כגון Google Analytics) לצורך הבנת השימוש באתר ושיפורו.</p>
        </Section>
        ...
        <Section title="3. שירותי צד שלישי">
          <p>האתר משתמש בשירות החיצוני Cal.com לניהול קביעת תורים, ובאמצעי תקשורת חיצוניים כגון WhatsApp, לצורך יצירת קשר ישיר. מידע שתמסור באמצעות שירותים אלו כפוף גם למדיניות הפרטיות של אותם ספקים. אנו עושים שימוש בעוגיות (Cookies) אנליטיות לצורך מדידת ביצועי האתר בלבד, ולא למטרות פרסום צד שלישי.</p>
        </Section>
