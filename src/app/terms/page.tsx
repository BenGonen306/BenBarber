    ...
    <section style={{ padding: "120px 1.5rem 100px", maxWidth: 800, margin: "0 auto" }}>
      ...
      <div style={{ background: C.surface, border: "1px solid rgba(212,175,55,0.15)", borderRadius: 20, padding: "36px 32px" }}>
        ...
        <Section title="2. קביעת תורים והרשמה לקורסים">
          <p>קביעת תורים במספרה מתבצעת באמצעות מערכת חיצונית (Cal.com) המקושרת מהאתר. הרשמה לקורסי האקדמיה מתבצעת באמצעות טופס השארת פרטים, ולאחריה ייצור הצוות שלנו קשר טלפוני או באמצעות הודעה לתיאום פרטים נוספים. אנו שומרים את הזכות לשנות, לבטל או לדחות תור או רישום בהודעה מוקדמת ובכפוף לכל דין.</p>
        </Section>
